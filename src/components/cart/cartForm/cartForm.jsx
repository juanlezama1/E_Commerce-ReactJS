        ...
        <>
            <Form layout='vertical' name="basic" labelAlign="right" labelCol={{span: 16}} wrapperCol={{span: 16}} style={{maxWidth: 600}} initialValues={{remember: true}} onFinish={onFinish} autoComplete="off">
                ...
                <div className="row align-items-center">
                    <div className="col-4">
                        <img style={{height: '50px'}} src='images/payment_methods/mercado_pago.png'></img>
                    </div>

                    <div className="col-4">
                        <img style={{height: '140px'}} src='images/payment_methods/visa.png'></img>
                    </div>

                    <div className="col-4">
                        <img style={{height: '80px'}} src='images/payment_methods/mastercard.png'></img>
                    </div>
                </div>
