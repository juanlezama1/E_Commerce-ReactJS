      ...
      <div className='row m-4 categories'>
        ...
        <div className='col-6'>
          <Link to={'/categories/consoles'} className='Card text-center text-decoration-none'>
            <Card hoverable cover={<img className='category_image' alt="consolas" src='images/filters/consolas2.webp' />}>
        ...
        <div className='col-6'>
          <Link to={'/categories/genres'} className='Card text-center text-decoration-none'>
              <Card hoverable cover={<img className='category_image' alt="consolas" src='images/filters/genres.webp' />}>
        ...
        <div className='col-6'>
          <Link to={'/categories/peripherals'} className='Card text-center text-decoration-none'>
              <Card hoverable cover={<img className='category_image' alt="perifericos" src='images/filters/peripherals.webp' />}>
